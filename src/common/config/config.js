...
module.exports = {
    default_module: 'api',
    weixin: {
        appid: 'wxd17a0aa299887666', // 小程序 appid
        secret: 'cb9a9142319d055882bb53a516854deb', // 小程序密钥
   ...
   mianexpress:{
    ...
    qiniu: {
        access_key: 'gCP-eFWaFuC7q5deY_t6lhoN_yuK7lKkhwQNk1t6',      // 在七牛密钥管理中获取
        secret_key: 'Mzv8LrXPRISy79IOT3FsY736fm0MuPJ6RN8yOh7j',    // 在七牛密钥管理中获取
        bucket: 'linc1',                    // 请填自己的bucket的名称
        domain: 'http://rozr7k8g5.hn-bkt.clouddn.com/'                         // 请填自己的domain域名
    },
    // 在七牛新建一个https的空间，这个是用来存储分享图片的https图片，对应的是goods表中的https_pic_url
    qiniuHttps: {
        access_key: 'gCP-eFWaFuC7q5deY_t6lhoN_yuK7lKkhwQNk1t6', // 在七牛密钥管理中获取
        secret_key: 'Mzv8LrXPRISy79IOT3FsY736fm0MuPJ6RN8yOh7j', // 在七牛密钥管理中获取
        bucket: 'test123', // 自己设置的
        domain: 'http://rozr7k8g5.hn-bkt.clouddn.com/', // 自己设置，例如：'http://img.你的域名.com/',别忘了这个”/“
